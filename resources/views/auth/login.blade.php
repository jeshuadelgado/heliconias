...
<title>Inicio Sesión</title>
  ...
  <meta charset="utf-8" />
        ...
        <link href="{{asset('css/estilosIS.css')}}" rel="stylesheet" />
            ...
            <div class="row g-0">
                ...
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      <button style="color: black" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Ingresar</button>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                    <div class="icono">
                        <i style="" class='far fa-user-circle' style='font-size:48px'></i>
                    </div>
                </div>
              </div>
            </div>
